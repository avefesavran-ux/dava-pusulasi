  ...
  const navItems = [
    {
      ...
      d: "M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607zM10.5 7.5h3m-3 3h3"
    },
    {
    ...
    },
    {
      id: 'forum',
      label: 'Hukuk Forumu',
      d: "M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193-.303.025-.607.045-.912.059A11.483 11.483 0 0118 19.773a11.581 11.581 0 00-2.686-1.5c-.327-.109-.659-.204-.995-.282A8.96 8.96 0 0115 15.75v-1.5c0-1.31-.329-2.546-.911-3.623"
    },
  ];
          ...
          <div className={`p-8 pb-10 transition-all duration-700 ${!isSidebarOpen ? 'flex justify-center' : ''}`}>
            <div className="flex items-center gap-5">
              ...
              <div className={`transition-all duration-700 overflow-hidden whitespace-nowrap ${isSidebarOpen ? 'opacity-100 translate-x-0 w-auto' : 'opacity-0 -translate-x-4 w-0 pointer-events-none'}`}>
                <h1 className="text-2xl font-serif tracking-tight text-slate-900 dark:text-luxury-silver leading-none cursor-pointer">
            ...
            >
              {user ? (
                ...
                <div className="flex items-center gap-3">
                  <span className="text-xs font-bold text-[#C5A059] uppercase tracking-widest hidden sm:block transition-colors">Üye Girişi</span>
